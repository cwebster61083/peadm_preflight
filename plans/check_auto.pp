# @summary Run peadm_preflight::check with topology auto-discovered from the PE primary.
#
...
# layout. The discovered hosts are then passed directly to peadm_preflight::check.
#
...
plan peadm_preflight::check_auto(
  ...
  run_plan('peadm_preflight::check', $preflight_params)
}
